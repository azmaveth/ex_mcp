  ...
  describe "OAuth 2.1 Client Credentials Flow - Error Handling" do
    ...
    test "handles invalid client credentials error" do
      ...
      case result do
        ...
        other -> flunk("Expected client error, got: #{inspect(other)}")
      end
    end
    ...
    test "handles unsupported grant type error" do
      ...
      case result do
        ...
        other -> assert true # Allow other errors for now
      end
    end
    ...
    test "handles server errors gracefully" do
      ...
      case result do
        ...
        {:error, {:http_error, status, _body}} when status >= 500 ->
          ...
          assert true
        other -> flunk("Expected server error handling, got: #{inspect(other)}")
      end
    end
      ...
      case result do
        {:ok, token_response} ->
          ...
          if String.contains?(token_response.access_token, ".") do
            ...
            assert length(parts) == 3  # JWT format
          end
