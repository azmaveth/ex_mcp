defmodule ExMCP.PromptsComplianceTest do
      ...
      case prompt.name do
        "code_review" ->
          ...
          [%{
            ...
            content: %{
              type: "text",
              text: "Review this #{arguments["language"]} code with #{focus} focus:\n#{arguments["code"]}"
            }
          }]
  ...
  describe "argument validation compliance" do
    test "validates required vs optional arguments correctly", %{client: client} do
      ...
      {:ok, _} = Client.get_prompt(client, "code_review", %{
        "code" => "test",
        "language" => "elixir", 
        "focus" => "performance"
      })
      ...
      {:error, reason} = Client.get_prompt(client, "code_review", %{
        "language" => "elixir"
    ...
    test "handles extra unexpected arguments gracefully", %{client: client} do
      ...
      {:ok, result} = Client.get_prompt(client, "code_review", %{
        "code" => "test",
        "language" => "elixir",
        "focus" => "readability",
