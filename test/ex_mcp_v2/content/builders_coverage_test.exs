defmodule ExMCP.Content.BuildersCoverageTest do
  ...
  describe "edge cases and error handling" do
    test "from_file handles missing files" do
      assert {:error, "File not found: /nonexistent/file.txt"} = from_file("/nonexistent/file.txt")
    end
    ...
    test "batch handles mixed content and errors" do
      contents = batch([
        ...
        fn -> raise "error" end,  # This will be caught
