defmodule ExMCP.Authorization do
  ...
  def exchange_code_for_token(params) do
    ...
    token_params =
      ...
      |> maybe_add_transaction_id(params)
  ...
  defp maybe_add_transaction_id(params, %{transaction_id: transaction_id})
       when is_binary(transaction_id),
       do: Map.put(params, :transaction_id, transaction_id)

  defp maybe_add_transaction_id(params, %{transaction: %{transaction_id: transaction_id}})
       when is_binary(transaction_id),
       do: Map.put(params, :transaction_id, transaction_id)

  defp maybe_add_transaction_id(params, _config), do: params
