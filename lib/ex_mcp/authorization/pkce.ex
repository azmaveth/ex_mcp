defmodule ExMCP.Authorization.PKCE do
  ...
  ## Example
      ...
      {:ok, verifier, challenge} = ExMCP.Authorization.PKCE.generate_challenge()

      # Use challenge in authorization request
      # Use verifier in token exchange request

      # Verify a code challenge (server-side)
      :ok = ExMCP.Authorization.PKCE.verify_challenge(verifier, challenge)
  """
  ...
  ## Example
      ...
      iex> {:ok, verifier, challenge} = ExMCP.Authorization.PKCE.generate_challenge()
  ...
  ## Example
      ...
      iex> {:ok, verifier, challenge} = ExMCP.Authorization.PKCE.generate_challenge()
      iex> ExMCP.Authorization.PKCE.verify_challenge(verifier, challenge)
      :ok
  """
  ...
  ## Example
      ...
      iex> ExMCP.Authorization.PKCE.validate_code_verifier("invalid!")
      {:error, :invalid_code_verifier}

      iex> {:ok, verifier, _} = ExMCP.Authorization.PKCE.generate_challenge()
      iex> ExMCP.Authorization.PKCE.validate_code_verifier(verifier)
      :ok
  """
