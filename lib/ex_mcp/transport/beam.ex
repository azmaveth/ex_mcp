defmodule ExMCP.Transport.Beam do
  ...
  defstruct [
    ...
    :target,         # pid() for local, {name, node()} for distributed
    :client_pid,     # our client process
    :connection_ref, # reference for monitoring
    :node_monitor    # node monitor reference for distributed mode
  ]
