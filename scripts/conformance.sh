...
run_all_versions() {
  # Only versions with conformance tests: 2025-06-18 and 2025-11-25
  # (2025-03-26 and 2024-11-05 have 0 test scenarios in the framework)
  local versions=("2025-11-25" "2025-06-18")
