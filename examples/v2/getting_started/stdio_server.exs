...
# Compare this to the legacy version - this is much cleaner!
...
# Use the built-in stdio transport (much simpler than manual JSON-RPC parsing!)
defmodule StdioRunner do
  def start do
    ...
    # Use the built-in stdio transport instead of manual JSON parsing
